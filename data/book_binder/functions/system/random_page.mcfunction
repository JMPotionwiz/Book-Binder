# This function is relient on data created by other functions. IT SHOULD ONLY BE CALLED BY OTHER FUNCTIONS!
...
# Remove the targeted page from the copied list of pages. This prevents the same page from being picked multiple times
